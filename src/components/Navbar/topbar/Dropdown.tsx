...
export default function Dropdown() {
  ...
  return (
    <div className="relative">
      <button className="flex items-center gap-1 outline-none" onClick={() => openDropdown ? hideDropdown() : setOpenDropdown((open) => !open)}>
        <Image
      ...
      <div onClick={() => hideDropdown()} className={classNames(openDropdown ? "" : "hidden", "fixed inset-0")}></div>
      {openDropdown && (
        <div className={
          classNames(
